...
/* template */
var __vue_render__$5 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c(_vm.href ? 'a' : 'button',{tag:"component",class:[
    "gb-base-button",
  ...
  computed: {
    ...
    validationMessage() {
      ...
      if (this.validation && this.validation.$dirty) {
        ...
        if (this.validation.required === false || this.validation.requiredIf === false || this.validation.requiredUnless === false) {
...
var __vue_render__$f = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:[
    ...
    "gb-field-input--" + _vm.computedStatus,
    {
      ...
      ]))+">"+_vm._ssrEscape(_vm._s(_vm.prepend))+"</span>"):"<!---->")),(_vm.leftIcon)?_c('base-icon',{staticClass:"gb-field-input__icon gb-field-input__icon--left",attrs:{"name":_vm.leftIcon}}):_vm._e(),_vm._ssrNode("<input"+(_vm._ssrAttr("autocomplete",_vm.autocomplete ? 'on' : 'off'))+(_vm._ssrAttr("disabled",_vm.disabled))+(_vm._ssrAttr("id",_vm.uuid))+(_vm._ssrAttr("max",_vm.max))+(_vm._ssrAttr("min",_vm.min))+(_vm._ssrAttr("name",_vm.name))+(_vm._ssrAttr("placeholder",_vm.placeholder))+(_vm._ssrAttr("spellcheck",_vm.spellcheck))+(_vm._ssrAttr("readonly",_vm.readonly))+(_vm._ssrAttr("type",_vm.type))+(_vm._ssrAttr("value",_vm.innerValue))+" class=\"gb-field-input__field js-tag-for-autofocus\">"),(_vm.computedRightIcon)?_c('base-icon',{staticClass:"gb-field-input__icon gb-field-input__icon--right",attrs:{"name":_vm.computedRightIcon},on:{"click":_vm.onRightIconClick}}):_vm._e(),_vm._ssrNode(((_vm.append)?("<span"+(_vm._ssrClass(null,[
        "gb-field-input__block",
...
var script$g = {
  ...
  methods: {
    ...
    onFieldKeyDown(event) {
      ...
      const numberKeys = ["1", "2", "3", "4", "5", "6", "7", "8", "9"]; // Do not continue when the key is not allowed
...
var __vue_render__$g = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:[
    ...
    "gb-field-input-numeric--" + _vm.size,
    "gb-field-input-numeric--" + _vm.computedTheme,
    "gb-field-input-numeric--" + _vm.computedStatus,
    {
      "gb-field-input-numeric--borders": _vm.borders,
      "gb-field-input-numeric--disabled": _vm.disabled,
      "gb-field-input-numeric--focused": _vm.focused,
      "gb-field-input-numeric--full-width": _vm.fullWidth,
      "gb-field-input-numeric--readonly": _vm.readonly,
      "gb-field-input-numeric--rounded": _vm.rounded,
      "gb-field-input-numeric--with-icon": _vm.leftIcon || _vm.rightIcon
    }
  ]},[(_vm.label)?_c('field-label',{staticClass:"gb-field-input-numeric__label",attrs:{"forField":_vm.uuid,"required":_vm.required,"size":_vm.size,"theme":_vm.theme}},[_vm._v(_vm._s(_vm.label))]):_vm._e(),_vm._ssrNode("<div class=\"gb-field-input-numeric__container\">","</div>",[_vm._ssrNode("<span class=\"gb-field-input-numeric__block gb-field-input-numeric__block--decrement gb-field-input-numeric__block--clickable\">-</span><span class=\"gb-field-input-numeric__block gb-field-input-numeric__block--increment gb-field-input-numeric__block--clickable\">+</span>"),(_vm.leftIcon)?_c('base-icon',{staticClass:"gb-field-input-numeric__icon gb-field-input-numeric__icon--left",attrs:{"name":_vm.leftIcon}}):_vm._e(),_vm._ssrNode("<input"+(_vm._ssrAttr("disabled",_vm.disabled))+(_vm._ssrAttr("id",_vm.uuid))+(_vm._ssrAttr("max",_vm.max))+(_vm._ssrAttr("min",_vm.min))+(_vm._ssrAttr("name",_vm.name))+(_vm._ssrAttr("placeholder",_vm.placeholder))+(_vm._ssrAttr("readonly",_vm.readonly))+" type=\"text\""+(_vm._ssrAttr("value",_vm.innerValue))+" class=\"gb-field-input-numeric__field js-tag-for-autofocus\">"),(_vm.rightIcon)?_c('base-icon',{staticClass:"gb-field-input-numeric__icon gb-field-input-numeric__icon--right",attrs:{"name":_vm.rightIcon}}):_vm._e(),_vm._ssrNode(((_vm.append)?("<span"+(_vm._ssrClass(null,[
        "gb-field-input-numeric__block",
        "gb-field-input-numeric__block--append",
        {
          "gb-field-input-numeric__block--clickable": _vm.$listeners.appendClick
        }
      ]))+">"+_vm._ssrEscape(_vm._s(_vm.append))+"</span>"):"<!---->"))],2),(_vm.fieldMessageStatus)?_c('field-message',{attrs:{"message":_vm.fieldMessageContent,"size":_vm.size,"status":_vm.fieldMessageStatus,"theme":_vm.theme}}):_vm._e()],1)};
